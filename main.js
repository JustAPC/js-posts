    ...
    `
      <div class="card">
        ...
        <div class="card-footer">
          ...
          <p>Piace a <span class="like-counter">${ element.likes }</span> persone</p>
        </div>
      </div>
    `
  }
...
likeButtons.forEach(
  (element, index) => {
    element.addEventListener("click", function(){
      ...
      const clickedCounter = likeCounters[index];
      let clickedCounterNum = parseInt(clickedCounter.innerHTML);
      ...
      if (element.classList.contains("liked"))
      {
        ...
        clickedCounterNum--;
        likedPosts = likedPosts.filter((element) => element != currentId);
        
      } else {

        element.classList.add ("liked");
        clickedCounterNum++;
        likedPosts.push(currentId);
        
      }
      console.log("Liked Posts: ", likedPosts)
      clickedCounter.innerHTML = clickedCounterNum;
    })
  }
)
